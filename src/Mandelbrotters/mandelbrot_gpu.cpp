...
Mandelbrot_GPU::Mandelbrot_GPU(const MandelbrotCalculator &obj) : MandelbrotCalculator(obj)
{
    GPUInit();
}

void Mandelbrot_GPU::GPUInit()
{
...
const char* Mandelbrot_GPU::TranslateOpenCLError(cl_int errorCode)
{
    switch (errorCode)
    {
